...
var regexIndexType = require('./regex_index');

var docSetType = new GraphQLObjectType({
  name: 'DocSet',
  ...
  fields: {
    ...
    enumIndexForString: {
      ...
      resolve: (root, args) => (0, _proskommaUtils.enumStringIndex)(root.enums[args.enumType], args.searchString)
    },
    enumRegexIndexesForString: {
      ...
      resolve: (root, args) => (0, _proskommaUtils.enumRegexIndexTuples)(root.enums[args.enumType], args.searchRegex)
    }
  }
});
